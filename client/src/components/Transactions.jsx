    ...
    <>
      <div className="bg-[#181918] m-4 flex flex-1 2xl:min-w-[450px] 2xl:max-w-[500px] sm:min-w-[270px] sm:max-w-[300px] flex-col p-3 rounded-md hover:shadow-2xl">
        <div className="flex flex-col items-center w-full mt-3">
          ...
          <img
            src={url != null ? url : `https://source.unsplash.com/300x400?${keyword}`}
            alt="Image"
            className="w-full h-64 2xl:h-96 rounded-2xl shadow-lg object-cover"
          />
      ...
      <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
        <div className="flex flex-col md:p-12 py-12 px-4">
          ...
          <div className="flex flex-wrap justify-center items-center my-2">
            {[...dummyData, ...transactions].reverse().map((itemTransaction, index) => (
              <TransactionCard key={index} {...itemTransaction} />
            ))}
          </div>
        </div>
      </div>
